...
public class exercicio2_4 {
	...
	String palavra1 = "vila";
	String palavra2 = "custo";
	String palavra3 = "receio";
	System.out.println(palavra1.equals(texto));
	System.out.println(palavra2.equals(texto));
	System.out.println(palavra3.equals(texto));
